...
{
  "$end", "error", "$undefined", "IDENT", "INTLIT", "STRINGLIT", "ADD",
  "LUI", "SLT", "COMMA", "$accept", "program", "dataSection",
  "textSection", "instSeq", "inst", "alInst", "cmInst", "cInst",
...
{
       0,    11,    12,     0,     6,     7,     8,    13,    14,    15,
      16,    17,    18,     3,    19,    19,    19,    15
};
...
#line 93 "grammar.y" /* yacc.c:1646  */
    {
			  ...
			  printf("Linha: %i Coluna: %i Identificador: %s\n", (yylsp[-1]).first_line, (yylsp[-1]).first_column, (yyvsp[0].u_string));
...
#line 117 "grammar.y" /* yacc.c:1646  */
    {
			  (yyval.u_string) = (yyvsp[0].u_ident);
			}

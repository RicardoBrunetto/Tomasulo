...
instrucao_I: ADDI reg comma reg comma NUMBER {if(passada == 1){ Def * d = get_def_mnemonico(mnemonico); if(d==NULL) yyerror(error_msg); $$.opcode = d->opcode; $$.rt = $2; $$.rs = $4; $$.imm = $6;}}
